...
# ARA: modified for jupyter notebook 01/27/23
# Usage: python qp_shifts.py
...
def qp_shifts(infilename, valtop):
    ...
    for i in condlist:
        print(i[0],i[1], file=outfile1)

    for i in vallist:
        print(i[0],i[1], file=outfile2)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--infilename', default='../sigma_hp.log', required=False)
    parser.add_argument('--valtop', default=4, required=False)
